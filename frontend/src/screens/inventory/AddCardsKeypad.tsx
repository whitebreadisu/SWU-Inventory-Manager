        ...
        <div className="ac-pad__resolve">
          ...
          <div className="ac-pad__resolve-controls">
            ...
            <SWUButton
              size="sm"
              active={canCommit}
              onClick={canCommit ? commitDraft : undefined}
            >
              Add Card
            </SWUButton>
          </div>
        ...
        <div className="ac-pad__list">
          {committed.length === 0 && (
            <div className="ac-pad__list-empty">
              No cards yet. Type a card number and press Enter (or click Add Card) to begin building your batch.
            </div>
          )}
          {committed.map((row) => {
