...
**Status:** 🟡 Open — steps 1-3 complete and live in production (schema, BL-27 census, ingestion script run for real); step 4 (snapshot regeneration) next; frontend port (BL-25/27/S6 territory) also outstanding before the catalog/inventory screens render correctly
