...
1. Dedicated session to triage the 18 open Dependabot PRs (5 failing major-version bumps need individual investigation; #11/#12 likely overlap with #21/#24).
2. If the app ever opens beyond its current known users, revisit rate limiting (A04) and `enforce_admins` on branch protection (A08).
